...
class UserService
{
    ...
    private function getUserData($request)
    {
        ...
        $users = $users->orderBy($sortBy, $sortOrder)->paginate($request->perPage);
    ...
    public function store($request)
    {
        try {
            ...
            if($request->has("branch_id") AND $request->branch_id){
                $org_id = Branch::find($request->branch_id)->organization_id;
